...
class BorderVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        conf.titleViewStyle = .ZCYTitleViewStyleBorder
        conf.borderColor = UIColor.green
        conf.borderWidth = 3
        conf.borderCornerRadius = 10
        
        var rect = CGRect(x: 0, y: 64, width: UIScreen.main.bounds.size.width, height: 30)
...
extension BorderVC: ZCYPageTitleViewDelegate {
...
extension BorderVC: ZCYPageContentViewDelegate {
