...
class CoverVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        conf.titleViewStyle = .ZCYTitleViewStyleCover
        conf.coverColor = UIColor.lightGray
...
extension CoverVC: ZCYPageTitleViewDelegate {
...
extension CoverVC: ZCYPageContentViewDelegate {
